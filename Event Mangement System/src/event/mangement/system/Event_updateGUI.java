 ...
 * @author LENOVO
 */
public class Event_updateGUI extends javax.swing.JFrame {
...
public static void setid(int ID){
    ...
    private void initComponents() {
        ...
        er_createbtn2 = new javax.swing.JButton();
        ...
        er_createbtn2.setBackground(new java.awt.Color(0, 153, 0));
        er_createbtn2.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 18)); // NOI18N
        er_createbtn2.setForeground(new java.awt.Color(255, 255, 255));
        er_createbtn2.setText("Search");
        er_createbtn2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                er_createbtn2ActionPerformed(evt);
            }
        });
        ...
        eventcreationpanelLayout.setVerticalGroup(
            ...
            .addGroup(eventcreationpanelLayout.createSequentialGroup()
                ...
                .addGroup(eventcreationpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(er_createbtn2, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(20, 20, 20)
                .addGroup(eventcreationpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jPanel1.add(eventcreationpanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 630, 770));
    ...
    private void er_createbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_er_createbtnActionPerformed
        ...
        int id = Integer.parseInt(ue_id.getText());

    try {
        eventDAO.deleteEvent(id);
        
        int eventID = Integer.parseInt(ue_id.getText());
        //scanner.nextLine();  // Consume newline left-over
        //System.out.print("Enter Name: ");
        String name = ue_name.getText();
        //System.out.print("Enter Date (YYYY-MM-DD): ");
        String date = ue_date.getText();
        //System.out.print("Enter Payment: ");
        double payment = Double.parseDouble(ue_pay.getText());
        //scanner.nextLine();  // Consume newline
        ///System.out.print("Enter Category: ");
        String category = (String) ue_cat.getSelectedItem();
        //System.out.print("Enter Location: ");
        String location = ue_loc.getText();
        //System.out.print("Enter Description: ");
        String description = ue_des.getText();
        ...
        Logger.getLogger(Event_updateGUI.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    private void er_createbtn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_er_createbtn2ActionPerformed
        // TODO add your handling code here:
        //id=Integer.parseInt(ue_id.getText());
        try {
        // TODO add your handling code here:
        
        List<Event> events = eventDAO.getAEvent(id);
        System.out.println("\nAll Events:");
        for (Event event : events) {
            ue_name.setText(event.getName());
                ue_date.setText(event.getDate());
                ue_pay.setText(String.valueOf(event.getPayment()));
                ue_cat.setSelectedItem(event.getCategory());
                    
                ue_loc.setText(event.getLocation() );
                ue_des.setText(event.getDescription());
        }
    ...
    }//GEN-LAST:event_er_createbtn2ActionPerformed
    ...
    private javax.swing.JButton er_createbtn2;
